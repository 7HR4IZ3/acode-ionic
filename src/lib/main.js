...
async function Main() {
  ...
  App.addListener("pause", pauseHandler);
  App.addListener("resume", resumeHandler);
...
async function onDeviceReady() {
  try {
    ...
    const isFreePackage = /(free)$/.test(appInfo.id);
    ...
    window.ANDROID_SDK_INT = parseInt(deviceInfo.androidSDKVersion);
    ...
    // Find way to get versionCode
    let versionCode = previousVersionCode,
