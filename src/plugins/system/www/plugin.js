module.exports = {
  ...
  fileAction: function (fileUri, filename, action, mimeType, onFail) {
    ...
    cordova.exec(function () {}, onFail, "System", "file-action", [
      fileUri,
      filename,
      action,
      mimeType
  ...
  launchApp: function (app, action, value, onSuccess, onFail) {
    cordova.exec(onSuccess, onFail, "System", "launch-app", [
      app,
      action,
      value
    ]);
  ...
  setUiTheme: function (systemBarColor, theme, onSuccess, onFail) {
    cordova.exec(onSuccess, onFail, "System", "set-ui-theme", [
      systemBarColor,
      theme
    ]);
  },
  ...
  execute: function (commandPath, { homeDir, background = true, args } = {}) {
